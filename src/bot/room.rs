...
impl Room {
    ...
    pub(crate) fn prepare_for_next_question(
        room_id: &String,
        redis: &mut redis::Connection,
    ...
    pub(crate) fn get_role_for_user(
        user_id: i32,
        room_id: &String,
        redis: &mut redis::Connection,
...
pub struct Context;
impl Context {
    pub fn get(user_id: i32, redis: &mut redis::Connection) -> redis::RedisResult<String> {
